...
############################################################################
## For ZEDBOARD RX and TX on MIO[48] and MIO[49] swaped compared to zc702

set_property iostandard "LVCMOS18" [get_ports "MIO[49]"]
set_property PACKAGE_PIN "D11" [get_ports "MIO[49]"]
...
set_property PACKAGE_PIN "C14" [get_ports "MIO[48]"]

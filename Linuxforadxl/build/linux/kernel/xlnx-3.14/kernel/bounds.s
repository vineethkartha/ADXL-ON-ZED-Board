...
@ /opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c
...
#APP
@ 19 "/opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c" 1
	
->NR_PAGEFLAGS #22 __NR_PAGEFLAGS	@
@ 0 "" 2
@ 20 "/opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c" 1
	
->MAX_NR_ZONES #3 __MAX_NR_ZONES	@
@ 0 "" 2
@ 21 "/opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c" 1
	
->NR_PCG_FLAGS #3 __NR_PCG_FLAGS	@
@ 0 "" 2
@ 23 "/opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c" 1
	
->NR_CPUS_BITS #2 ilog2(CONFIG_NR_CPUS)	@
@ 0 "" 2
@ 25 "/opt/PetaLinux/petalinux-v2014.2-final/components/linux-kernel/xlnx-3.14/kernel/bounds.c" 1
